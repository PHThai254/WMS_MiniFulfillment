...
|---|---|---|
| Xây dựng API Xác nhận nhặt hàng (Trừ tồn kho bằng Transaction) | Thái | ✅ Đã có trong `ConfirmPickAsync` |
| Xây dựng màn hình Picking List (lộ trình FIFO) trên Mobile | Đức Anh | 🔲 Chưa bắt đầu |
| Xây dựng luồng Picking Scanner (quét mã đối chiếu gợi ý) | Dũng | 🟡 Đang có `PickingScanner.tsx` — cần tích hợp PickingPlan |
| Haptic Feedback khi quét sai mã | Dũng | 🔲 Chưa bắt đầu |
| Tích hợp gọi API trừ tồn kho sau khi quét đúng | Đức Anh | 🔲 Chưa bắt đầu |
| **Fix Mock OCR → Gemini thật** | Thái | 🚨 Cần xử lý ngay |

---

*Báo cáo được tạo tự động bởi AI Tech Lead Analysis · Cập nhật lần cuối: 02/06/2026 00:05*
